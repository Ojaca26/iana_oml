...
def get_llms():
    ...
    with st.spinner("🧠 Inicializando la red de agentes IANA..."):
        try:
            ...
            llm_sql = ChatGoogleGenerativeAI(model="models/gemini-1.5-pro-latest", temperature=0.1, google_api_key=api_key)
            llm_analista = ChatGoogleGenerativeAI(model="models/gemini-1.5-pro-latest", temperature=0.1, google_api_key=api_key)
            llm_orq = ChatGoogleGenerativeAI(model="models/gemini-1.5-pro-latest", temperature=0.0, google_api_key=api_key)
